askmonkApp.controller('welcomeCtrl', function($scope, $state, $q, UserService, $ionicLoading) {
...
askmonkApp.controller('appCtrl', function($scope){

});

askmonkApp.controller('profileCtrl', function($scope, UserService, $ionicActionSheet, $state, $ionicLoading, $timeout){
