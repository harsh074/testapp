...
```sh
cordova plugin add https://github.com/harsh-iomedia/phonegap-pushplugin.git
```
...
```sh
phonegap local plugin add https://github.com/harsh-iomedia/phonegap-pushplugin.git
```
